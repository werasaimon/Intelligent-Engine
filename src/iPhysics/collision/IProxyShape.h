...
#include "shapes/ICollisionShape.h"
...
class IProxyShape
{
    ...
    protected:
        ...
        ITransform        mLocalToBodyTransform;
    ...
    public:
        ...
        /// Constructor
        IProxyShape(ICollisionBody* body , ICollisionShape* shape , const ITransform& transform, scalar mass=0 );
        ...
        const ITransform& getLocalToBodyTransform() const;

        /// Set the local to parent body transform
        void setLocalToBodyTransform(const ITransform& transform);
        ...
        bool testPointInside(const IVector3& worldPoint);
        ...
        IVector3 getLocalScaling() const;
 ...
 */
SIMD_INLINE const ITransform& IProxyShape::getLocalToBodyTransform() const
{
...
// Set the local to parent body transform
SIMD_INLINE void IProxyShape::setLocalToBodyTransform(const ITransform& transform)
{
 ...
 */
SIMD_INLINE const ITransform IProxyShape::getWorldTransform() const
{
 ...
 */
SIMD_INLINE IVector3 IProxyShape::getLocalScaling() const
{
 ...
 */
SIMD_INLINE void IProxyShape::setLocalScaling(const IVector3& scaling)
{
