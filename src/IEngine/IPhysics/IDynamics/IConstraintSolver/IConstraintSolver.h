...
class IConstraintSolver
{
   ...
   public :
       ...
       void SetConstrainedPositionsArrays(IMovement* constrainedPositions);
...
//  }
 ...
 // Set the constrained positions/orientations arrays
 SIMD_INLINE void IConstraintSolver::SetConstrainedPositionsArrays(IMovement* constrainedPositions)
 {
     assert(constrainedPositions != NULL);
     mConstraintSolverData.Positions = constrainedPositions;
 }
