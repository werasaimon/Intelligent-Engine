...
void IContactSolver::InitializeContactConstraints()
{
    ...
    for (u32 c=0; c<mNbContactManifolds; c++)
    {
        ...
        // Get the velocities of the bodies
        const IVector3& v1 = mVelocities[manifold->indexBody1].v / gamma1;
        const IVector3& w1 = mVelocities[manifold->indexBody1].w / gamma1;
        const IVector3& v2 = mVelocities[manifold->indexBody2].v / gamma2;
        const IVector3& w2 = mVelocities[manifold->indexBody2].w / gamma2;
...
void IContactSolver::SolveVelocityConstraint()
{
    ...
    for (u32 c=0; c<mNbContactManifolds; c++)
    {
        ...
        // Get the velocities of the bodies
        const IVector3& v1 = mVelocities[contactManifold->indexBody1].v * gamma1;
        const IVector3& w1 = mVelocities[contactManifold->indexBody1].w * gamma1;
        const IVector3& v2 = mVelocities[contactManifold->indexBody2].v * gamma2;
        const IVector3& w2 = mVelocities[contactManifold->indexBody2].w * gamma2;
