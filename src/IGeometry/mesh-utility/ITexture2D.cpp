...
// Constructor
ITexture2D::ITexture2D(uint _ID)
    : mID(_ID), mLayer(0), mWidth(0), mHeight(0)
{

}

// Constructor
ITexture2D::ITexture2D(int width, int height, int internalFormat, int format, int type)
...
void ITexture2D::setID(const uint &iD)
{
  mID = iD;
}
...
//// Create the texture
//void ITexture2D::create(int width, int height, int internalFormat, int format, int type, void* data)
//{
...
//void ITexture2D::createDepth( int width, int height)
//{
