...
namespace IEngine
{
    ...
    namespace MeshGenerator
    {
        ...
        */
        ...
        \see CurveDescriptor
        */
        using CurveFunction = std::function<IVector3(float t)>;
        ...
        struct CuboidDescriptor
        {
            ...
            IVector3  size  = IVector3(float(1.0));
        ...
        struct EllipsoidDescriptor
        {
            ...
            IVector3  radius  = IVector3(float(0.5));
        ...
        struct ConeDescriptor
        {
            ...
            IVector2     radius          = IVector2(float(0.5));
        ...
        struct TorusDescriptor
        {
            ...
            IVector2     ringRadius      = IVector2(float(0.5));

            //! Radius of the inner tube in X, Y, and Z direction. By default (0.25, 0.25, 0.25).
            IVector3     tubeRadius      = IVector3(float(0.25));
        ...
        struct TorusKnotDescriptor
        {
            ...
            IVector3     ringRadius      = IVector3(float(0.25));
        ...
        void GenerateMesh(const EllipsoidDescriptor& desc, IMeshModel& mesh);

        //! Generates and returns a new ellipsoid (also sphere) mesh with the specified descriptor.
        IMeshModel GenerateMeshT(const EllipsoidDescriptor& desc);
        //================================================================+++++++++++++++++++++=//
        ...
        void GenerateMesh(const CylinderDescriptor& desc, IMeshModel& mesh);

        //! Generates and returns a new cylinder mesh with the specified descriptor.
        IMeshModel GenerateMeshT(const CylinderDescriptor& desc);
        //================================================================+++++++++++++++++++++=//
        ...
        void GenerateMesh(const PieDescriptor& desc, IMeshModel& mesh);

        //! Generates and returns a new (also pie-diagram) mesh with the specified descriptor.
        IMeshModel GenerateMeshT(const PieDescriptor& desc);
        //================================================================+++++++++++++++++++++=//
        ...
        void GenerateMesh(const PipeDescriptor& desc, IMeshModel& mesh);

        //! Generates and returns a new pipe (i.e. cylinder with a hole) mesh with the specified descriptor.
        IMeshModel GenerateMeshT(const PipeDescriptor& desc);
        //================================================================+++++++++++++++++++++=//
        ...
        void GenerateMesh(const TorusDescriptor& desc, IMeshModel& mesh);

        //! Generates and returns a new torus mesh with the specified descriptor.
        IMeshModel GenerateMeshT(const TorusDescriptor& desc);
        //================================================================+++++++++++++++++++++=//
        ...
        void GenerateMesh(const TorusKnotDescriptor& desc, IMeshModel& mesh);

        //! Generates and returns a new torus-knot mesh with the specified descriptor.
        IMeshModel GenerateMeshT(const TorusKnotDescriptor& desc);
        //================================================================+++++++++++++++++++++=//
        ...
        void GenerateMesh(const SpiralDescriptor& desc, IMeshModel& mesh);

        //! Generates and returns a new spiral mesh with the specified descriptor.
        IMeshModel GenerateMeshT(const SpiralDescriptor& desc);
        //================================================================+++++++++++++++++++++=//
        ...
        void GenerateMesh(const CurveDescriptor& desc, IMeshModel& mesh);

        //! Generates and returns a new curve mesh (as a rope along a given curve function) with the specified descriptor.
        IMeshModel GenerateMeshT(const CurveDescriptor& desc);
         //================================================================+++++++++++++++++++++=//
        ...
        void GenerateMesh(const BezierPatchDescriptor& desc, IMeshModel& mesh);

        //! Generates and returns a new Bezier patch mesh with the specified descriptor.
        IMeshModel GenerateMeshT(const BezierPatchDescriptor& desc);
        //================================================================+++++++++++++++++++++=//
