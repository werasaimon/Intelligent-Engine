...
// Set the scaling vector of the collision shape
SIMD_INLINE void ICollisionShapeSphere::SetLocalScaling(const IVector3& scaling)
{
...
// Return a local support point in a given direction without the object margin
SIMD_INLINE IVector3 ICollisionShapeSphere::GetLocalSupportPointWithMargin(const IVector3& direction) const
{
 ...
 */
SIMD_INLINE void ICollisionShapeSphere::GetLocalBounds(IVector3& min, IVector3& max) const
{
 ...
 */
SIMD_INLINE void ICollisionShapeSphere::ComputeLocalInertiaTensor(IMatrix3x3& tensor, scalar mass) const
{
 ...
 */
SIMD_INLINE void ICollisionShapeSphere::ComputeAABB(IAABB& aabb, const ITransform& transform) const
{
...
// Return true if a point is inside the collision shape
SIMD_INLINE bool ICollisionShapeSphere::TestPointInside(const IVector3& localPoint, IProxyShape* proxyShape) const
{
