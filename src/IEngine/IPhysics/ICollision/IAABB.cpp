...
//    const IVector3 point2 = ray.Origin + ray.maxFraction * (ray.Direction);
//    const IVector3 e = mMaxCoordinates - mMinCoordinates;
//    const IVector3 d = point2 - ray.Origin;
//    const IVector3 m = ray.Origin + point2 - mMinCoordinates - mMaxCoordinates;

    const IVector3 point2 = ray.Origin + ray.maxFraction * (ray.Direction - ray.Origin);
    const IVector3 e = mMaxCoordinates - mMinCoordinates;
    const IVector3 d = point2 - ray.Origin;
    const IVector3 m = ray.Origin + point2 - mMinCoordinates - mMaxCoordinates;
