 ...
 */
ICollisionBody* ICollisionWorld::createCollisionBody(const ITransform &transform)
{
 ...
 */
SIMD_INLINE void ICollisionWorld::raycast(const IRay& ray, IRaycastCallback* raycastCallback, unsigned short raycastWithCategoryMaskBits) const
{
