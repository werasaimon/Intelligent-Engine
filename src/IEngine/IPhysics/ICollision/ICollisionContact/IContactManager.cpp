...
#include "../../ICollision/ICollisionBroadPhase/IBroadPhase.h"
#include "../../ICollision/ICollisionNarrowPhase/ICollisionAlgorithmGjkEpa.h"
...
void IContactManager::ComputeNarrowPhase()
{
    ...
    for (auto it = mOverlappingPairs.begin(); it != mOverlappingPairs.end(); )
    {
        ...
        IContactGenerationPoints* generate_contact = new  IContactGenerationPoints( shape1 , shape2 , narrowPhaseAlgorithm );
