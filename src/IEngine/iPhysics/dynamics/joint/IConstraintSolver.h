#ifndef ICONSTRAINTSOLVER_H
#define ICONSTRAINTSOLVER_H
...
struct IConstraintSolverData
{
   ...
   public :
    ...
    IVelocity*             Velocities;
    ILocationsAndRotation* Positions;
...
//          Vector3* SplitAngularVelocities;
       ...
       const std::map<IRigidBody*, u32>& mapBodyToConstrainedVelocityIndex;

       /// True if warm starting of the solver is active
       bool isWarmStartingActive;

       /// Constructor
       IConstraintSolverData(const std::map<IRigidBody*, u32>& refMapBodyToConstrainedVelocityIndex)
...
class IConstraintSolver
{
   ...
   private :
       ...
       IConstraintSolverData mConstraintSolverData;
   ...
   public :
       ...
       /// Constructor
       IConstraintSolver(const std::map<IRigidBody *, u32> &mapBodyToVelocityIndex);
       ...
       void solveVelocityConstraints(IIsland* island);

       /// Solve the position constraints
       void solvePositionConstraints(IIsland* island);
       ...
       void setConstrainedPositionsArrays(ILocationsAndRotation* constrainedPositions);



//          /// Set the constrained split velocities arrays
//          void setSplitVelocitiesArrays(Vector3* constrainedSplitLinearVelocities,
//                                        Vector3* constrainedSplitAngularVelocities);
...
//  // Set the constrained velocities arrays
//  SIMD_INLINE void IConstraintSolver::setSplitVelocitiesArrays(Vector3* SplitLinearVelocities,
//                                                                Vector3* SplitAngularVelocities)
//  {
//      assert(SplitLinearVelocities != NULL);
//      assert(SplitAngularVelocities != NULL);
//      mConstraintSolverData.SplitLinearVelocities  = SplitLinearVelocities;
//      mConstraintSolverData.SplitAngularVelocities = SplitAngularVelocities;
//  }

//  // Set the constrained velocities arrays
//  SIMD_INLINE void IConstraintSolver::setConstrainedVelocitiesArrays(Vector3* constrainedLinearVelocities,
//                                                                      Vector3* constrainedAngularVelocities)
//  {
...
//  // Set the constrained positions/orientations arrays
//  SIMD_INLINE void IConstraintSolver::setConstrainedPositionsArrays(Vector3*    constrainedPositions,
//                                                                     Quaternion* constrainedOrientations)
//  {
...
//  }
 ...
 // Set the constrained velocities arrays
 SIMD_INLINE void IConstraintSolver::setConstrainedVelocitiesArrays(IVelocity* constrainedVelocities)
 {
     assert(constrainedVelocities != NULL);
     mConstraintSolverData.Velocities = constrainedVelocities;
 }

 // Set the constrained positions/orientations arrays
 SIMD_INLINE void IConstraintSolver::setConstrainedPositionsArrays(ILocationsAndRotation* constrainedPositions)
 {
     assert(constrainedPositions != NULL);
     mConstraintSolverData.Positions = constrainedPositions;
 }
